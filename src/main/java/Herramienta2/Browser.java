...
public class Browser {
	...
	public WebDriver seleccionarBrowser(String browser) throws MalformedURLException {
		 ...
		 switch (browser)
	        {
	            case "Chrome":
	            	System.setProperty("webdriver.chrome.driver", "/Users/edgar.reza/chromedriver");
...
//		  builder.usingDriverExecutable(new File("/Users/edgar.reza/.nvm/versions/node/v20.15.0/bin/node"));
