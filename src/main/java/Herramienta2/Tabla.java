...
public class Tabla extends Application {
    ...
    final HBox driverMobile= new HBox();
    final HBox driverMobile1= new HBox();
	        ...
	        suite.setOnAction(new EventHandler<ActionEvent>() {
	            public void handle(ActionEvent e) {
	            	...
	            	if(tipo_browser_suite==null) {
	                	...
	                	Alert alerta = new Alert(AlertType.ERROR);
	                	alerta.setTitle("Automatizaci�n");
            ...
            Button actualizar = new Button();
		        ...
		        pantalla_agregar.setOnAction(new EventHandler<ActionEvent>() {
		            @Override public void handle(ActionEvent e) {
		                 ...
		                 driverMobile.getChildren().clear();
		                 driverMobile1.getChildren().clear();
			        ...
			        .addListener(new ChangeListener<String>() {
				        public void changed(ObservableValue<? extends String> observable,
				        	...
				        	if(seleccion=="Click") {
				        		...
				        		gu.getChildren().addAll(valor,agregar_datos);
					             ...
					             public void handle(ActionEvent e) {
                              ...
                              else if(seleccion=="CloseDriverWeb") {
                              	...
                              	alert.getChildren().clear();
                              	changew.getChildren().clear();
  				        		gu.getChildren().addAll(agregar_datos);
  					   	        gu.setSpacing(3);
                              ...
                              else if(seleccion=="CloseDriverMobile") {
                              	...
                              	alert.getChildren().clear();
                              	changew.getChildren().clear();
  				        		driverMobile.getChildren().addAll(agregar_datos);
  					   	        driverMobile.setSpacing(3);
		   	        ...
		   	        driverMobile1.getChildren().addAll(agregar,driverMobile);
		   	        driverMobile1.setSpacing(3);
		  
		   			final VBox vbox1 = new VBox();
		   	        vbox1.setSpacing(5);
		   	        vbox1.setPadding(new Insets(10, 0, 0, 10));
		   	        vbox1.getChildren().addAll(agrega_paso,pn,comb,gu1,wait1,photo1,gettext1,vacio1,dropdown1,swipe1,swipeweb1,pressback1,alert1,changew1,driverMobile1);
